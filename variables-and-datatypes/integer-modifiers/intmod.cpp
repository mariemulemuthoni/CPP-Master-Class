...
int main(){
    ...
    //Can store both +ve and -ve numbers
    signed int value3 {15}; 
    signed int value4{-400};

    unsigned int value5 {4};//Only +ve values are allowed

    std::cout << "Value 1 : " << value1 << std::endl;
    std::cout << "Value 2 : " << value2 << std::endl;
    std::cout << "Signed Value 3 : " << value3 << std::endl;
    std::cout << "Signed Value 4 : " << value4 << std::endl;
    std::cout << "Unsigned Value 5 : " << value5 << std::endl;
